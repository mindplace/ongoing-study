...
class AboutRegularExpressions < Neo::Koan
  ...
  ## I don't understand: what causes that to be a negated regexp?
  ## since a range is acceptable as a search element, the + means
  ## to be greedy and get whatever is available, and the ^
  ## means to anchor to the beginning of the line...
  ...
  ## don't understand what the block is or how it's affecting .sub
